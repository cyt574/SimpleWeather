...
public class HefengWeather {
    ...
    public static HefengResult requestData(String location, boolean useEnglish) {
        final String httpUrl = "http://apis.baidu.com/heweather/weather/free";
        final String httpArg = "city=";
        final String APP_KEY_HOURLY = "b263472174789256d72388037e770944";
    ...
    public static HefengResult requestInternationalData(String location) {
        final String httpUrl = "http://apis.baidu.com/heweather/weather/free";
        final String httpArg = "city=";
        final String APP_KEY_INTERNATIONAL = "b263472174789256d72388037e770944";
